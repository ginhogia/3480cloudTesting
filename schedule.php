...
$meetings = Meeting::getMeetingsByClubAndRacyear($session->getClub()->getId(), $racyear);
...
var MeetingList = function(element)
{
  ...
  me.showEditor = function(meeting)
  {
    ...
    me.element.editor.find("[data-ref='location']").val(meeting.location);
    me.element.editor.find("[data-ref='reg_time']").val(meeting.reg_time);
  ...
  me.element.editor.find("[data-link='save']").click(function()
  {
    ...
    meeting.location = me.element.editor.find("[data-ref='location']").val();
    meeting.reg_time = me.element.editor.find("[data-ref='reg_time']").val();
    meeting.racyear = '<?php echo $racyear ?>';
...
var ddlYear= function(element){
	...
	me.ddl.on('change' ,function(){
		var strUrl = "schedule.php?racyear=" + this.value;
          ...
          <div class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true" data-ref="editor">
            ...
            <div class="modal-body">
              <form class="form-horizontal">
                ...
                <div class="control-group">
                  <label class="control-label" for="meeting_location">例會地點</label>
                  <div class="controls">
                    <input type="text" id="meeting_location" data-ref="location" />
                  </div>
                </div>
                <div class="control-group">
